...
The sample CAD assets are collected from publicly available data (e.g. from [grabcad.com](https://grabcad.com/library)) and more information as well as the respecitve workflows each asset were utilized for can be found in the respective [sub-directory](./sample-assets/README.md)
