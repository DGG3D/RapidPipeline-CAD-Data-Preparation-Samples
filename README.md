...
![screenshot](image/RapidPipeline_CAD-Dataprep.jpg)
*Exemplary CAD Data Preparation & 3D Processing Pipeline Process Flowchart*

## Sample Assets

The sample CAD assets are collected from publicly available data (e.g. from [grabcad.com](https://grabcad.com/library)) and more information as well as the respective workflows each asset were utilized for can be found in the respective [sub-directory](./sample-assets/README.md)

## Processing Samples

The processing samples can be found in the respective [sub-directory](./workflows/README.md) and correspond to each identified step in the CAD Dataprep and 3D Processing Pipeline needed to go from a "raw" parametric CAD dataset to CGI and real-time render-ready 3D data set.  
